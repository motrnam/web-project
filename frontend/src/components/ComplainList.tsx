...
const ComplaintList: React.FC = () => {
  ...
  const [editingComplaint, setEditingComplaint] = useState<RegisterComplain | undefined>();
  ...
  const mockComplaint: RegisterComplain = {
    ...
    description: "در تاریخ ۱۵ دی‌ماه ۱۴۰۲، افراد ناشناس با شکستن درب ورودی وارد منزل شده و اقدام به سرقت طلا و وجه نقد نموده‌اند.",
        ...
        <div className="grid gap-4">
          {complaints.length > 0 ? (
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-4 text-sm">
                      <div className="flex items-center gap-2">
                        <span className="text-gray-500 dark:text-gray-500">زمان وقوع:</span>
                        <span className="text-gray-900 dark:text-white">
                          {new Date(complaint.incident_datetime).toLocaleDateString("fa-IR")}
                        </span>
                      </div>
                      
                      <div className="flex items-center gap-2">
                        <span className="text-gray-500 dark:text-gray-500">محل:</span>
                        <span className="text-gray-900 dark:text-white">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-gray-500 dark:text-gray-500">نوع جرم:</span>
                        <span className="text-gray-900 dark:text-white">
            ...
            <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg shadow">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">هیچ شکایتی ثبت نشده</h3>
